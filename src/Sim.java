...
public class Sim extends Application {
    ...
    double spMouseX = 0;
    double spMouseY = 0;
    double screenMouseX = 0;
    double screenMouseY = 0;
    ...
    Constants.Language language = Constants.Language.ENGLISH;
    ...
    public void start(Stage primaryStage) {
        ...
        // Actually lets start in a halted mode.
        //handleHaltButton();
        initMainLoop();
        resetAll();

        // And then let's actually start but we are halted
        //start();
    ...
    public void handleHaltButton() {
	    scenario.toggleHalt();
        if (scenario.halted == true) {
            btnHalt.setText("Resume");
        } else {
    ...
    public void setTextLanguage(Constants.Language lang) {
        ...
        switch (lang) {
            case ENGLISH:
                stage.setTitle("Drone Search and Rescue Simulation");
            ...
            case JAPANESE:
                stage.setTitle("ドローン捜索救助シミュレーション");

                // Top bar
                btnStart.setText("開始");
                //btnPause.setText("一時停止する");
            ...
            case BOTH:
                stage.setTitle("ドローン捜索救助シミュレーション Drone Search and Rescue Simulation");

                // Top bar
                btnStart.setText("開始 Start");
                //btnPause.setText("一時停止する Pause");
...
/*
    ...
    public void setTopBarButtonSizes() {
        ...
        btnSave.setPrefSize(prefWid, prefHgt);
        btnHalt.setPrefSize(prefWid, prefHgt);
    }
    ...
    public HBox createTopHBox() {
        ...
        btnHalt.setOnAction(new EventHandler<ActionEvent>() {    
            @Override
            public void handle(ActionEvent event) {
                handleHaltButton();
            }
        ...
        hbox.getChildren().addAll(btnStart, btnHalt, btnReset, btnBuild, btnSave);
        return hbox;
    }
    ...
    public VBox createLeftVBox() {
        ...
        addTitledPane(accordion, vBoxSimulation, "Simulation");
        TitledPane exp = addTitledPane(accordion, vBoxDroneConfig, "Drone Configuration");
        //addTitledPane(accordion, vBoxBehavior, "Behaviors");
        //addTitledPane(accordion, vBoxSensor, "Sensors");
        addTitledPane(accordion, vBoxCurrentData, "Current Data");

        // We'll default to this one opened...
        accordion.setExpandedPane(exp);
