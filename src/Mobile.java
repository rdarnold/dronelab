...
public class Mobile extends Collidable {
    double maxSpeed = 3.0; // this is usually super fast actually
    private double maxVerticalSpeed = maxSpeed / 3.0; // Typical speed
    ...
    double verticalAccelerationRate = 0.0;
    ...
    public void adjustSpeed() {
        ...
        switch (getVerticalHeading()) {
            ...
            case UP:
                ...
                if (zSpeed > maxVerticalSpeed) {
                    zSpeed = maxVerticalSpeed;
                }
                break;
            case DOWN:
